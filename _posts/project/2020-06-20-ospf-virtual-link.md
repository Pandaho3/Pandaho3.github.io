...
当你选择使用虚链路，标明你的网络中某一部分设计不规范，最好的方法还是重新规划设计，虚链路仅是作为修复无法避免的网络拓扑问题的一种临时手段。
...
##  项目背景
! [图例](https://github.com/Pandaho3/Pandaho3.github.io/assets/img/ospf-virtual-link/1.png)
